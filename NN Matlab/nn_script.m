...
% Created 13-Oct-2017 10:20:42
% F.Marchesani - Master Thesis
%
% This script assumes this variable is defined:
%
%   pt - feedback time series
%   pt contains just the time series that we need to feed the network
%   (in our application the online providers as a function of the time)
%   See attached MATLAB environment for more details!

T = tonndata(pt,true,false);
...
feedbackDelays = 1:20;
hiddenLayerSize = 20;
% Here we can change the number of delays/hidden neurons
...
% (!) PAY ATTENTION, Important for data prediction (!)
[y2,xfc,afc] = netc(cell(0,10000),xic,aic);
% The second number in cell(x,y) represents the number of predictions to made
